package com.example.uilibrary.sidebar.sidebar;
...
public class WaveSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextColor = Color.parseColor("#ff555555");
    ...
    private void drawLetters(Canvas canvas) {
        ...
        if (isTouch) {
            ...
            mLettersPaint.setColor(Color.parseColor("#ffbfbfbf"));
            mLettersPaint.setAntiAlias(true);
            canvas.drawRect(rectF, mLettersPaint);
        }

package com.example.samplemodule.permisssion;
...
public class PerssionsRequest {
    ...
    public PerssionsRequest(Context context, OnPermissionRequestListener onPermissionRequestListener, String[] permissions) {
    ...
    public PerssionsRequest(Context context, OnPermissionRequestListener onPermissionRequestListener, boolean isFinish, String[] permissions) {
        this.context = context;
        this.onPermissionRequestListener = onPermissionRequestListener;
    ...
    public PerssionsRequest(Context context) {
        isRequireCheck = true;
        this.context = context;
...
//    if (requestCode == PerssionsRequest.PERMISSION_REQUEST_CODE && perssionsRequest.hasAllPermissionsGranted(grantResults)) {
